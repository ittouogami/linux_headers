deps_config := \
	...
	drivers/staging/wilc3000/Kconfig \
...
ifneq "$(KERNELVERSION)" "5.4.0"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "aarch64-linux-gnu-gcc (Linaro GCC 7.2-2017.11-rc1) 7.2.1 20171011"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/opt/Xilinx/SDK/2018.2/gnu/aarch64/lin/aarch64-linux/bin/aarch64-linux-gnu-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/opt/Xilinx/SDK/2018.2/gnu/aarch64/lin/aarch64-linux/bin/aarch64-linux-gnu-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "/opt/Xilinx/SDK/2018.2/gnu/aarch64/lin/aarch64-linux/bin/aarch64-linux-gnu-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "/opt/Xilinx/SDK/2018.2/gnu/aarch64/lin/aarch64-linux/bin/aarch64-linux-gnu-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
